...
/**
 * Identity and money only. Navigation moved to the thumb (see BottomNav), so
 * the top of the screen no longer spends a row on tabs the user can already
